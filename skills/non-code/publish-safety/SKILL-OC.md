...
# publish-safety (OpenClaw)

Bin: `bin/publish-safety`. Canon en `SKILL.md`. Bloqueo tecnico antes de `--publish`.
...
publish-safety jitter
```

## Skills relacionadas

mkt-publish, approval-gate, editorial-calendar
