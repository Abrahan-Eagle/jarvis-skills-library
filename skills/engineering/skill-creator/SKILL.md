...
Claude loads `FORMS.md`, `REFERENCE.md`, or `EXAMPLES.md` only when needed (illustrative filenames — create them when the skill needs progressive disclosure).
...
Claude reads `REDLINING.md` or `OOXML.md` only when the user needs those features (illustrative filenames).
