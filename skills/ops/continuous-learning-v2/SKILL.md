...
description: >
  ECC instincts: continuous learning v2, evolve clusters into skills. Use with session-learner-ops at module close. Trigger: instincts, evolve, homunculus.
license: UNLICENSED
metadata:
  ...
  triggers: continuous learning v2, ecc
  related-skills:
    - ecc-router
    - ecc
    - jarvis-core
