...
description: >
  ECC OWASP security review checklist (complement to security skill). Trigger: security review ecc, OWASP scan checklist when ECC installed.
license: UNLICENSED
metadata:
  ...
  scope: [global]
  category: ops
  upstream: ecc:security-review
  auto_invoke:
    - "ECC security-review"
  triggers: security review ecc, ecc
  related-skills:
    - ecc-router
    - ecc
    - jarvis-core
