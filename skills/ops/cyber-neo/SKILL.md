...
After Phase 1 completes, launch **5 parallel subagents** using the Task tool (Cursor). Each subagent receives the target path, the reconnaissance results, and phase-specific instructions.
