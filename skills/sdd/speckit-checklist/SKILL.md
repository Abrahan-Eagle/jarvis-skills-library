...
description: >
  Genera checklists de calidad para validar requisitos (unit tests for English). Trigger: Validar spec o plan, /speckit-checklist.
license: MIT
compatibility: Requires .specify/ directory (run specify init in product repo)
metadata:
  author: github-spec-kit
  version: "0.11.2"
  upstream: github/spec-kit:templates/commands/checklist.md
  category: sdd
  auto_invoke:
    - "Checklist calidad spec/plan Spec Kit"
---
