...
description: >
  Convierte tasks.md en issues GitHub para tracking. Solo con OK usuario y remote GitHub. Trigger: /speckit-taskstoissues tras speckit-tasks.
license: MIT
...
metadata:
  ...
  category: sdd
  auto_invoke:
    - "Convertir tasks Spec Kit a issues GitHub"
---
...
0. STOP: confirmar que el usuario pidió explícitamente crear issues en GitHub para esta feature; si no, ofrecer lista numerada y detenerse.
