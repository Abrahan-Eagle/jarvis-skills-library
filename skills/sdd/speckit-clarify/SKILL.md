...
description: >
  Clarifica requisitos ambiguos en spec.md antes de planificar. Trigger: Antes de speckit-plan, spec incompleto, /speckit-clarify.
license: MIT
compatibility: Requires .specify/ directory (run specify init in product repo)
metadata:
  author: github-spec-kit
  version: "0.11.2"
  upstream: github/spec-kit:templates/commands/clarify.md
  category: sdd
  auto_invoke:
    - "Requisitos ambiguos antes de plan SDD"
---
