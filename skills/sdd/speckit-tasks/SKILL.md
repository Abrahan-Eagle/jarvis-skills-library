...
name: speckit-tasks
description: >
  Descompone plan.md en tasks.md accionables con dependencias. Trigger: Tras speckit-plan, /speckit-tasks.
license: MIT
compatibility: Requires .specify/ directory (run specify init in product repo)
metadata:
  author: github-spec-kit
  version: "0.11.2"
  upstream: github/spec-kit:templates/commands/tasks.md
  category: sdd
  auto_invoke:
    - "Descomponer plan Spec Kit en tareas"
---
