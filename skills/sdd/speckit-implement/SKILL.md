...
description: >
  Ejecuta tasks.md según el plan. Solo con OK explícito del usuario. Trigger: /speckit-implement tras analyze.
license: MIT
compatibility: Requires .specify/ directory (run specify init in product repo)
metadata:
  author: github-spec-kit
  version: "0.11.2"
  upstream: github/spec-kit:templates/commands/implement.md
  category: sdd
  auto_invoke:
    - "Implementar feature Spec Kit con OK usuario"
---
