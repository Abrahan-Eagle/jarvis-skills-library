...
description: >
  Análisis de coherencia cross-artifact entre spec, plan y tasks. Trigger: Tras speckit-tasks, antes de implement, /speckit-analyze.
license: MIT
compatibility: Requires .specify/ directory (run specify init in product repo)
metadata:
  author: github-spec-kit
  version: "0.11.2"
  upstream: github/spec-kit:templates/commands/analyze.md
  category: sdd
  auto_invoke:
    - "Análisis coherencia Spec Kit pre-implement"
---
