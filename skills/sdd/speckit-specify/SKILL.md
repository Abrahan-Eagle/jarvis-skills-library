...
description: >
  Define qué construir (requisitos y user stories) antes del stack técnico. Trigger: Nueva feature de producto, /speckit-specify, spec-driven development.
license: MIT
compatibility: Requires .specify/ directory (run specify init in product repo)
metadata:
  author: github-spec-kit
  version: "0.11.2"
  upstream: github/spec-kit:templates/commands/specify.md
  category: sdd
  auto_invoke:
    - "Nueva feature de producto con Spec Kit"
---
